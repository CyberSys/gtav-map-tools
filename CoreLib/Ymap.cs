...
namespace CoreLib
{
    ...
    public class CMapData
    {
        ...
        public InstancedMapData instancedData { get; set; }
        ...
        public CMapData(CMapData map)
        {
            ...
            parent = map.parent;
            flags = map.flags;
            contentFlags = map.contentFlags;
            streamingExtentsMin = map.streamingExtentsMin;
            streamingExtentsMax = map.streamingExtentsMax;
            entitiesExtentsMin = map.entitiesExtentsMin;
            entitiesExtentsMax = map.entitiesExtentsMax;
            entities = map.entities;
            containerLods = map.containerLods;
            boxOccluders = map.boxOccluders;
            occludeModels = map.occludeModels;
            physicsDictionaries = map.physicsDictionaries;
            instancedData = map.instancedData;
            carGenerators = map.carGenerators;
            LODLightsSOA = map.LODLightsSOA;
            DistantLODLightsSOA = map.DistantLODLightsSOA;
            block = map.block;
        }
        ...
        public CMapData(string filename)
        {
            ...
            flags = 0;
            contentFlags = 0;
            streamingExtentsMin = Vector3.Zero;
            streamingExtentsMax = Vector3.Zero;
            entitiesExtentsMin = Vector3.Zero;
            entitiesExtentsMax = Vector3.Zero;
