...
namespace CoreLib
{
    ...
    public class CMapTypes
    {
        ...
        public void UpdatelodDist(float add,float mult)
        {
            foreach (CBaseArchetypeDef arc in archetypes)
            {
                arc.lodDist = add + (mult * arc.bsRadius);
        ...
        public XElement WriteXML()
        {
            ...
            CMapTypesNode.Add(new XElement("extensions"));
            ...
            CMapTypesNode.Add(new XElement("dependencies"));
            CMapTypesNode.Add(new XElement("compositeEntityTypes"));
